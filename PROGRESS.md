...
**Last updated:** Push 44 (MEKF wired onto the `AttitudeEstimator` component: Davenport cold start, fine↔coarse arbitration surfaced to FDIR — closes REQ-ADET-004)
...
**Test gates (all green):** 487 C++ lib unit (ASan/UBSan) · 15 F´ component unit ·
28 integration ·
4 GMAT golden · 108 Python collected — 106 passed, 2 skipped without GMAT
