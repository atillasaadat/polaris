...
**Last updated:** Push 43 (§5.3 disturbance torques: gravity-gradient, aero/SRP CP–CM lever arms, residual dipole — per-torque scenario switches)
...
**Test gates (all green):** 487 C++ lib unit (ASan/UBSan) · 9 F´ component unit ·
28 integration ·
