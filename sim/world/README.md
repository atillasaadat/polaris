...
| `third_body.{hpp,cpp}` | Sun/Moon point-mass differential gravity | via ephemeris |
| `ephemeris_file.{hpp,cpp}` | DE440-fitted Chebyshev segment loader | `tests/golden/de440_sun_moon.cheb` |
