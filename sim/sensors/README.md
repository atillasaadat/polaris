...
| `sun_sensor.{hpp,cpp}` | **Two contracts:** analogue → per-diode cosine-law counts; digital → sun vector with incidence-dependent accuracy; albedo from occlusion fractions | counts *or* unit vector |
